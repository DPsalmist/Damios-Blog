...
class PostListView(ListView):
	model = Post
	template_name = 'blog/home.html' #<app>/<model>/<viewtypet>.html
	context_object_name = 'posts'
	ordering = ['-date_posted'] #to make the newest post show at the top
	paginate_by = 3

class UserPostListView(ListView):
	model = Post
	template_name = 'blog/user_posts.html' #<app>/<model>/<post_list>.html
	context_object_name = 'posts'
	ordering = ['-date_posted'] #to make the newest post show at the top
	paginate_by = 3
